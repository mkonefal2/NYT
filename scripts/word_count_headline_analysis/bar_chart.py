...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default=os.path.join(os.path.dirname(__file__), 'D:\\Projekty\\NYT\\static\\plots'), help='Directory to save the output plots')
